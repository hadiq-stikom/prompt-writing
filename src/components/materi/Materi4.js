        ...
        <div className="space-y-32 pb-20 text-white">
            ...
            <ScrollReveal>
                <section className="space-y-8">
                    <div className="flex items-center gap-4 text-primary font-bold tracking-widest text-sm uppercase">
                        <span className="w-8 h-px bg-primary"></span> Pendahuluan
                    </div>
            ...
            <ScrollReveal>
                <section className="space-y-16">
                    <div className="space-y-4">
                        <div className="flex items-center gap-4 text-primary font-bold tracking-widest text-sm uppercase">
                            <span className="w-8 h-px bg-primary"></span> Bagian 01
                        </div>
            ...
            <ScrollReveal>
                <section className="space-y-16">
                    <div className="space-y-4">
                        <div className="flex items-center gap-4 text-primary font-bold tracking-widest text-sm uppercase">
                            <span className="w-8 h-px bg-primary"></span> Bagian 02
                        </div>
                    ...
                    <div className="space-y-12 relative before:absolute before:left-8 before:top-8 before:bottom-8 before:w-px before:bg-white/10">
                        {[
                            ...
                            <div key={i} className="relative pl-16 group">
                                <div className="absolute left-0 top-0 w-16 h-16 glass border border-white/10 rounded-2xl flex items-center justify-center font-black text-xl text-primary group-hover:bg-primary group-hover:text-white group-hover:border-primary transition-all shadow-sm">
                                    {i + 1}
                                </div>
            ...
            <ScrollReveal>
                <section className="space-y-16">
                    <div className="space-y-4">
                        <div className="flex items-center gap-4 text-primary font-bold tracking-widest text-sm uppercase">
                            <span className="w-8 h-px bg-primary"></span> Bagian 04
                        </div>
                        <h2 className="text-3xl font-bold dark:text-white">Proposal Projek (Bisnis/Praktis)</h2>
                    </div>
                    ...
                    <div className="grid gap-6">
                        <div className="p-10 bg-primary rounded-[3rem] text-white shadow-2xl relative overflow-hidden group">
                            ...
                            <div className="flex justify-center gap-4">
                                <div className="px-8 py-3 border border-white/20 rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-white/10 transition-all cursor-pointer">Submit Prompt</div>
                                <div className="px-8 py-3 bg-white text-primary rounded-full text-[10px] font-black uppercase tracking-widest hover:shadow-lg transition-all cursor-pointer">Lihat Contoh</div>
                            </div>
                        </div>
                    </div>
                </section>
