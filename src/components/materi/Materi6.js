...
export default function Materi6({ materi }) {
    return (
        <div className="space-y-32 pb-20 text-white">
            ...
            {/* 1. KONFIGURASI MYSQL & PRISMA */}
            <ScrollReveal>
                <section className="space-y-12">
                    <div className="flex justify-between items-end">
                        <div className="px-8 py-4 glass rounded-full border border-white/10 inline-block">
                            <h3 className="text-emerald-400 font-bold text-xs uppercase tracking-widest">01. Konfigurasi MySQL & Prisma (40 Menit)</h3>
                        </div>
                        <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Goal: Database Connection Success</span>
                    </div>
  ...
  stock Int
            ...
            <ScrollReveal>
                <section className="space-y-12">
                    <div className="flex justify-between items-end">
                        <div className="px-8 py-4 glass rounded-full border border-white/10 inline-block">
                            <h3 className="text-emerald-400 font-bold text-xs uppercase tracking-widest">02. REST API Routes (50 Menit)</h3>
                        </div>
                        <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Goal: Data Highway established</span>
                    </div>

                    <div className="space-y-8">
                        <p className="text-slate-400 max-w-3xl">API Route adalah jembatan antara Frontend dan Database. Di sini kita mendefinisikan bagaimana aplikasi "meminta" data dan "mengirim" data baru ke MySQL.</p>
            ...
            <ScrollReveal>
                <section className="space-y-12">
                    <div className="flex justify-between items-end">
                        <div className="px-8 py-4 glass rounded-full border border-white/10 inline-block">
                            <h3 className="text-emerald-400 font-bold text-xs uppercase tracking-widest">03. Integrasi & Refactoring (30 Menit)</h3>
                        </div>
                        <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Goal: Full-Stack Sync</span>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div className="space-y-6">
                            ...
                            <div className="p-8 bg-slate-900 border border-white/10 rounded-[2.5rem] shadow-2xl space-y-4">
                                <h5 className="text-xs font-bold text-emerald-400 uppercase tracking-widest">🚀 Agent-Optimized Prompt (PCTF):</h5>
                                <p className="text-sm font-mono text-slate-200 leading-relaxed italic">
                                    "Lakukan refactor pada app/inventaris/page.tsx (Frontend) untuk mengganti mock data dengan integrasi API asli. Gunakan useEffect untuk fetch data secara sinkron, dan pastikan form submission mengirim request POST ke server sebelum melakukan refresh state UI (Format)."
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="relative group">
                            ...
                            <div className="relative p-8 glass rounded-[2.5rem] border border-white/10 space-y-4 bg-slate-900 font-mono text-[10px] leading-relaxed">
                                ...
                                <p className="text-emerald-400 mt-4 italic">Result: Persistent Dashboard</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="bg-slate-900 border border-white/5 rounded-[4rem] p-16 text-white overflow-hidden relative shadow-2xl">
                    ...
                    <div className="relative z-10 space-y-12">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            {/* Testing Prompts */}
                            <div className="space-y-6">
                                <div className="p-8 glass border border-white/10 rounded-4xl space-y-4 group hover:border-emerald-500/30 transition-all">
                            ...
                            {/* Troubleshooting */}
                            <div className="p-8 glass border border-white/10 rounded-4xl flex flex-col justify-center space-y-6 group hover:border-red-500/30 transition-all">
                                <h5 className="text-[10px] font-black text-red-400 uppercase tracking-widest flex items-center gap-2">
                                    <span>🔧</span> Troubleshooting (Connection)
                                </h5>
                                ...
                                <div className="pt-4 border-t border-white/5">
                                    <p className="text-[9px] text-slate-500 uppercase tracking-widest">Pro Tip: Cek status service MySQL Anda di System Services.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <ScrollReveal>
                <section className="text-center max-w-4xl mx-auto py-24 space-y-12">
                    <div className="space-y-6">
                        <h2 className="text-4xl font-bold dark:text-white italic underline underline-offset-12 decoration-emerald-500/20 capitalize tracking-tight">System Ready for Production</h2>
                    ...
                    <div className="flex justify-center gap-6">
                        <div className="px-10 py-4 bg-emerald-500 text-white rounded-2xl font-bold hover:shadow-emerald-500/20 hover:shadow-lg transition-all cursor-pointer">Explore Advanced Backend →</div>
                    </div>
